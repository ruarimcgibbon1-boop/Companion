...
| 3 | 2026-08-27 | USABLE | 6 | +2.395 | +2.084 | +4.972 | 1 (YYGH +0.311R) | 1 (CRWD:bos +2.888R) | +1,218.79 | +1,018.19 | +200.60 | HEALTHY (29,361 rows) | Yes | CLEAN_WITH_FINDINGS | Issue 1 recurrence — **most severe** (FWDI ≈−$256.7/−0.924R vs local −$17.24, 2,529 sh un-ingested, ~2h26m stale; YYGH ≈+$71.8 vs local +$32.92); Issue 4 decisions post-freeze append-drift (benign, prefix proven); Mac daemon stopped 22:23:16Z | matched 6/6; broker precision tiered (pair −$184.91 exact, FWDI per-share UNRESOLVED); excursion 3/10 signal-inst · 2/9 symbol; FWDI lag = Issue 1 not Issue 2 |
